    ...
    def draw(self, context):
        ...
        if variants:
            ...
            for variant in variants:
                ...
                variant_box.label(text=f"Route: {route:.2f} m")
                variant_box.label(
                    text=f"Mean Persistence: {persistence * 100:.1f}%"
                )
                variant_box.label(
                    text=f"Early Reveal: {early * 100:.1f}%"
                )
                variant_box.label(text=f"Mean Depth: {depth:.2f} m")
